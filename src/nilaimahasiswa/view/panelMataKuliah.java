...
public class panelMataKuliah extends JPanel {
    ...
    private void initComponents() {
        ...
        btnTambah.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        btnTambah.setBackground(new java.awt.Color(80, 110, 85));
        btnTambah.setForeground(new java.awt.Color(255, 255, 255));
        btnTambah.setText("Tambah");
        btnTambah.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 13));
        btnTambah.setFocusPainted(false);
        btnTambah.setBorderPainted(false);
        btnTambah.setContentAreaFilled(true);
        btnTambah.setOpaque(true);
        btnTambah.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
