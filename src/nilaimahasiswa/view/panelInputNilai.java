...
public class panelInputNilai extends JPanel {
    ...
    private void initComponents() {
        ...
        btnCari.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        btnCari.setText("Cari");
        btnCari.setBackground(new java.awt.Color(80, 110, 85));
        btnCari.setForeground(new java.awt.Color(255, 255, 255));
        btnCari.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 13));
        btnCari.setFocusPainted(false);
        btnCari.setBorderPainted(false);
        btnCari.setContentAreaFilled(true);
        btnCari.setOpaque(true);
        btnCari.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));

        btnSimpan.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        btnSimpan.setBackground(new java.awt.Color(80, 110, 85));
        ...
        btnSimpan.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
        btnUbah.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        ...
        btnHapus.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(214, 69, 65), 1));
        btnHapus.setContentAreaFilled(true);
        btnHapus.setOpaque(true);
        btnHapus.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
        btnBersihkan.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        btnBersihkan.setBackground(new java.awt.Color(255, 255, 255));
        btnBersihkan.setForeground(new java.awt.Color(120, 130, 145));
        btnBersihkan.setText("Bersihkan");
        btnBersihkan.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 13));
        btnBersihkan.setFocusPainted(false);
        btnBersihkan.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(120, 130, 145), 1));
        btnBersihkan.setContentAreaFilled(true);
        btnBersihkan.setOpaque(true);
        btnBersihkan.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));

        btnPrev.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        btnPrev.setText("< Prev");
        btnPrev.setBackground(new java.awt.Color(80, 110, 85));
        btnPrev.setForeground(new java.awt.Color(255, 255, 255));
        btnPrev.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 13));
        btnPrev.setFocusPainted(false);
        btnPrev.setBorderPainted(false);
        btnPrev.setContentAreaFilled(true);
        btnPrev.setOpaque(true);
        btnPrev.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
        btnNext.setUI(new javax.swing.plaf.basic.BasicButtonUI());
        btnNext.setText("Next >");
        btnNext.setBackground(new java.awt.Color(80, 110, 85));
        btnNext.setForeground(new java.awt.Color(255, 255, 255));
        btnNext.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 13));
        btnNext.setFocusPainted(false);
        btnNext.setBorderPainted(false);
        btnNext.setContentAreaFilled(true);
        btnNext.setOpaque(true);
        btnNext.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
